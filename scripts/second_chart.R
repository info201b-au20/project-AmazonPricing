...
# How likely BBCorrectedPrice is (not) the lower price, based on different
# vendor type

# Faceted histogram:
# three categories by vendor type : Amazon, FBA, Other.
# (“ScrapedIndexVendortype”)
# showing the distribution of “CorrectedPrice” / ”BBCorrectedPrice” log ratio
# of all vendor listings.
...
second_chart <- ggplot(data = corrected_price_to_BBs_ratios, aes(x = PriceLogRatio)) +
