...
prices_main_content_pyt <- mainPanel(
  ...
  p(" "),
  p(
    "This faceted histogram show the ",
    strong("distribution of each vendor type"),
    "for 250 best selling products' all price listings from the dataset"
  ),
  p(
    strong("Buy Box"), "Price listings is highlighted in cyan.",
    span(em("Buy box"),
      em(
        "product is the one pops up first as a suggested purchase on Amazon's ",
  ...
  p(
    "In general, in each histogram, listing counts to the", strong("left"),
